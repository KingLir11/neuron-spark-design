            ...
            <div className="hidden md:flex items-center space-x-2">
              ...
              {user ? (
                <div className="flex items-center space-x-2">
                  {isAdmin && (
                    <span className="text-xs bg-primary/20 text-primary px-2 py-1 rounded flex items-center">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="text-gray-300 hover:text-primary transition-colors duration-200 p-2 rounded-sm focus:outline-none focus:ring-2 focus:ring-primary"
                    title="Sign out"
                  >
            ...
            <div className="flex flex-col py-4">
              ...
              {user ? (
                <div className="border-t border-gray-700/50 mt-2 pt-2">
                  {isAdmin && (
                    <div className="px-6 py-2">
                      <span className="text-xs bg-primary/20 text-primary px-2 py-1 rounded inline-flex items-center">
                        <Shield className="w-3 h-3 mr-1" />
                        Admin
                      </span>
                    </div>
                  ...
                  <button
                    ...
                    className="text-gray-300 hover:text-primary hover:bg-dark-200/50 transition-colors duration-200 flex items-center px-6 py-4 text-base font-medium w-full"
                  >
                ...
                <button
                  ...
                  className="text-gray-300 hover:text-primary hover:bg-dark-200/50 transition-colors duration-200 flex items-center px-6 py-4 text-base font-medium w-full border-t border-gray-700/50 mt-2"
                >
