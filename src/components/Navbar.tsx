  ...
  return (
    <header className={cn(
      ...
      <div className="container mx-auto px-4 py-3 sm:py-4">
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden py-4 animate-fade-in border-t border-gray-700 mt-3">
            <div className="flex flex-col space-y-1">
              {navLinks.map(link => (
                <button
                  key={link.href}
                  onClick={() => handleNavClick(link.href)}
                  className="text-gray-300 hover:text-primary hover:bg-dark-100 transition-colors duration-200 text-left px-4 py-3 rounded-md focus:outline-none focus:text-primary focus:bg-dark-100 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-200"
                >
                  {link.title}
                </button>
              ))}
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-300 hover:text-primary hover:bg-dark-100 transition-colors duration-200 flex items-center px-4 py-3 rounded-md focus:outline-none focus:text-primary focus:bg-dark-100 focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-dark-200"
