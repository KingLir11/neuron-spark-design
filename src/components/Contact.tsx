          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <Input type="text" name="name" placeholder="Your Name" value={formData.name} onChange={handleInputChange} className="bg-dark-100 border-gray-700 text-white" />
                </div>
                <div>
                  <Input type="email" name="email" placeholder="Your Email" value={formData.email} onChange={handleInputChange} className="bg-dark-100 border-gray-700 text-white" />
                </div>
                <div>
                  <Textarea name="message" placeholder="Your Message" value={formData.message} onChange={handleInputChange} className="bg-dark-100 border-gray-700 text-white min-h-[120px]" />
                </div>
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-dark-100 p-5 rounded-lg flex items-start my-[18px] py-[16px]">
                ...
                <div className="bg-dark-100 p-5 flex items-start my-[11px] rounded-lg py-[21px]">
